...
class AnimalsCollectionViewController: UICollectionViewController {
    ...
    var bearcollection = [BearCollection]()
    ...
    private func accessAnimalsCollectionPlist(){
        ...
        for input in inputColArray as! [Dictionary<String, String>] {
            bearcollection.append(BearCollection(imageName: input["imageName"]!, caption: input["caption"]!))
        }
    }
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let bear = bearcollection[indexPath.section]
        //cell!.textLabel?.text = bear.caption
        
        cell.backgroundColor = UIColor.black
        cell.imageView.image = UIImage(named: bear.imageName)
        return cell
    }
