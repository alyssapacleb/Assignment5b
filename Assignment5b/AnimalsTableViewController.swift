...
class Animal {
    ...
    init(footer: String, gallery_name: String, identifier: String, name: String, scientificName: String, _class: String, size: String, image: String){
        self.footer = footer
...
struct currentGallery {
    ...
    static var currentGalleryFooter = "SHARKS"
}
...
class AnimalsTableViewController: UITableViewController {
    ...
    private func accessAnimalsPlist(){
        ...
        for input in inputArray as! [Dictionary<String, String>] {
            animals.append(Animal(footer: input["footer"]!, gallery_name: input["gallery_name"]!, identifier: input["identifier"]!, name: input["name"]!, scientificName: input["scientific name"]!, _class: input["class"]!, size: input["size"]!, image: input["image"]!))
        }
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row % 2 == 0 {
            let selectedAnimal = animals[indexPath.row/2]
            currentGallery.currentIdentifier = selectedAnimal.identifier
            currentGallery.currentGalleryName = selectedAnimal.gallery_name
            currentGallery.currentGalleryFooter = selectedAnimal.footer
